    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.playlist_btn:
                startActivity(new Intent(AlbumActivity.this,PlayListActivity.class));
                finish();
                break;
            case R.id.track_btn:
                startActivity(new Intent(AlbumActivity.this,TrackActivity.class));
                finish();
                break;
            case R.id.get_music_btn:
                startActivity(new Intent(AlbumActivity.this,GetMusicActivity.class));
                finish();
                break;
            case R.id.player_btn:
                ...
                break;
            case R.id.play_btn:
                toaster("Play selected track or album in this activity and/or end previous service.");
                break;
